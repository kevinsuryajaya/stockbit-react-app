...
function CustomCard(props) {
    ...
    return (
        <div className='card-container'>
            <img className='card-image' src={movie.Poster} onClick={handleShowDialog} alt='movies' />
            {modal && (
                <dialog
                    className="dialog"
                    open
            ...
            <div className='card-content'>
                ...
                <div className='card-footer'>
                    ...
                    <div>
                    {!isWatchlist && <button className='watchlist-button' onClick={() => props.handleAddWatchlist(movie)}>+ Add to Watchlist</button>}
                    </div>
